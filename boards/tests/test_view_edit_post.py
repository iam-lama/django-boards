...
class PostUpdateViewTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.post = Post.objects.create(message='Lorem ispum dolor sit amet', topic=self.topic, created_by=user)
...
class LoginRequiredPostUpdateViewTests(PostUpdateViewTestCase):
    def test_redirection(self):
        ...
        url = self.url
        self.assertRedirects(response, f'{login-url}?next={url}'.format(login_url,url))
